  ...
  createClass(List, null, [{
    ...
    value: function buildResourceList(_ref) {
      ...
      var _embedded = response._embedded,
          ...
          count = _response$count === undefined ? 0 : _response$count,
          _response$_links = response._links,
          _links = _response$_links === undefined ? [] : _response$_links;
      ...
      list.nextPage = function () {
        return getResources(_extends({}, params, List.getNextPageParams(_links)), callback);
      };
      list.previousPage = function () {
        return getResources(_extends({}, params, List.getPreviousPageParams(_links)), callback);
      };
